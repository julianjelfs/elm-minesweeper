...
var _user$project$View$header = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$View$bombCount(model),
				_user$project$View$startButton(model),
				_user$project$View$timer(model)
			]));
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Click to reveal a square, Ctrl-click to flag a square')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('game-area')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$RandomPositions$get = A3(
	_elm_lang$core$Task$perform,
	_user$project$Types$Dummy,
...
var _user$project$Main$keyBoard = _elm_lang$core$Platform_Sub$batch(
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$keyboard$Keyboard$downs(_user$project$Types$KeyDown),
	...
	main: _elm_lang$html$Html_App$program(
		{
			...
			subscriptions: function (m) {
				return _elm_lang$core$Platform_Sub$batch(
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$Main$timerSub(m),
							_user$project$Main$keyBoard
						]));
			}
		})
};
