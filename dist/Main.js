...
var _user$project$Config$config = {dimensions: 10, initialBombs: 15};

var _user$project$Types$addBombToGrid = F2(
	function (coord, grid) {
		return A3(
			_elm_lang$core$Dict$update,
			coord,
...
var _user$project$Types$nearbyCells = F2(
	function (grid, coord) {
		return A2(
			...
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: _user$project$Types$dec, _1: _user$project$Types$dec},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: _user$project$Types$dec, _1: _user$project$Types$id},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: _user$project$Types$dec, _1: _user$project$Types$inc},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: _user$project$Types$id, _1: _user$project$Types$dec},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: _user$project$Types$id, _1: _user$project$Types$inc},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: _user$project$Types$inc, _1: _user$project$Types$dec},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: _user$project$Types$inc, _1: _user$project$Types$id},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: _user$project$Types$inc, _1: _user$project$Types$inc},
											_1: {ctor: '[]'}
										}
									}
								}
		...
		F2(
			function (t, d) {
				return A3(
					_elm_lang$core$Dict$insert,
					t,
					_user$project$Types$createCell(t),
					d);
			}),
		_elm_lang$core$Dict$empty,
		keys);
...
var _user$project$Types$ClickedCell = function (a) {
	return {ctor: 'ClickedCell', _0: a};
};
var _user$project$Types$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Types$StartGame = {ctor: 'StartGame'};
var _user$project$Types$Positions = function (a) {
	return {ctor: 'Positions', _0: a};
};
var _user$project$Types$Dummy = function (a) {
...
var _user$project$View$bombCount = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('bomb-count'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$View$youWin = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('you-win'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$button,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$StartGame),
							_1: {ctor: '[]'}
						}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Start Again'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$View$header = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$bombCount(model),
			_1: {
				ctor: '::',
				_0: _user$project$View$startButton(model),
				_1: {
					ctor: '::',
					_0: _user$project$View$timer(model),
					_1: {ctor: '[]'}
				}
			}
		});
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Click to reveal a square, Ctrl-click to flag a square'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$View$header(model),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('see-code'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('See the code '),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$a,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$href('https://github.com/julianjelfs/elm-minesweeper'),
													_1: {ctor: '[]'}
												}
											},
											{
...
var _user$project$RandomPositions$rndPos = F3(
	function (n, pos, seed) {
		rndPos:
		while (true) {
			var num = _elm_lang$core$Set$size(pos);
			if (_elm_lang$core$Native_Utils.eq(num, n)) {
				return pos;
			} else {
				var _p0 = A2(
					_elm_lang$core$Random$step,
...
var _user$project$RandomPositions$get = A2(
	_elm_lang$core$Task$perform,
	_user$project$Types$Positions,
	A2(
		_elm_lang$core$Task$andThen,
		function (t) {
			return _elm_lang$core$Task$succeed(
				A3(
					_user$project$RandomPositions$rndPos,
					_user$project$Config$config.initialBombs,
	...
	function (model, grid, cell) {
		...
		if (_p0 === true) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					state: _user$project$Types$Lost,
					grid: A2(
...
var _user$project$State$flagCell = F2(
	function (model, cell) {
		var changeState = F2(
			function (b, s) {
				return _elm_lang$core$Native_Utils.update(
...
var _user$project$Main$keyBoard = _elm_lang$core$Platform_Sub$batch(
	{
		ctor: '::',
		_0: _elm_lang$keyboard$Keyboard$downs(_user$project$Types$KeyDown),
		_1: {
			ctor: '::',
			_0: _elm_lang$keyboard$Keyboard$ups(_user$project$Types$KeyUp),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Main$timerSub = function (model) {
	var _p0 = model.state;
	if (_p0.ctor === 'Playing') {
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		...
		subscriptions: function (m) {
			return _elm_lang$core$Platform_Sub$batch(
				{
					ctor: '::',
					_0: _user$project$Main$timerSub(m),
					_1: {
						ctor: '::',
						_0: _user$project$Main$keyBoard,
						_1: {ctor: '[]'}
					}
				});
		}
