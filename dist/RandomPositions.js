...
var Elm = {};
Elm['RandomPositions'] = Elm['RandomPositions'] || {};
if (typeof _user$project$RandomPositions$main !== 'undefined') {
    _user$project$RandomPositions$main(Elm['RandomPositions'], 'RandomPositions', undefined);
}
